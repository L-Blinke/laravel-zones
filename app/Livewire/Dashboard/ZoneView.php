...
class ZoneView extends Component
{
    ...
    public function refresh(){
        ...
        try {
            ...
            $this->count = EmergencyRoom::has('patient')->count() / 4;
            $this->totalCount = EmergencyRoom::has('patient')->count();
            $this->first = true;
        } catch (\Throwable $th) {
            //throw $th;
        }
    ...
    public function render()
    {
        ...
        return view('livewire.dashboard.zone-view');
    }
}
