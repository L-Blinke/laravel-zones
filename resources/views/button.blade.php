        ...
        <div class="overflow-visible w-12xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-visible bg-white p-8 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="container mx-auto justify-center">
                    <button type="button"
                        class="rounded-full bg-primary p-3 text-xs font-medium uppercase leading-normal text-white shadow-lg transition duration-150 ease-in-out hover:bg-primary-700 focus:bg-primary-700 focus:outline-none focus:ring-0 active:bg-primary-800"
                        data-te-toggle="modal" data-te-target="#exampleModalWithIcon" data-te-ripple-init
                    ...
                    <div data-te-modal-init
                        ...
                        id="exampleModalWithIcon" tabindex="-1" aria-labelledby="exampleModalWithIconLabel"
                        aria-hidden="true">
                        <div data-te-modal-dialog-ref
                            ...
                            <div
                                ...
                                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                                    <form action="/api/call/make" method="post">
                                        @csrf
                                        <div class="relative mb-3" data-te-input-wrapper-init>
                                            <input type="text" name="r"
                                                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                                                id="exampleFormControlInput1" placeholder="Call reason" />
                                            <label for="exampleFormControlInput1"
                                                class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary">
                                                Call reason
                                            </label>
                                        </div>
                                        <select name="t" data-te-select-init>
                                            <option value="BlueCode">BlueCode</option>
                                            <option value="GeneralCode">GeneralCode</option>
                                        </select>
